...
description: "Join VeoZax SMP - the ultimate MCPE cross-version server network supporting 0.14.3, 0.15.10, 1.1.5, Craftsman, and 1.21.80+. Connect via vz.veozax.xyz:25590 or play.veozax.xyz:25590 or VeoZax.minecraft.pe:19132."
...
* **Server Address (IP):** `VZSMP.minecraft.pe` / `play.veozax.xyz`
* **Port:** `25590`
...
| **MCPE 0.15.10 – 1.1.5** | Hybrid RakNet Protocol Translation | Custom Auth Bypass / Local | `VeoZax.minecraft.pe:19132` |
| **Bedrock 1.2.0 – 1.20.x** | PocketMine Protocol Adapter | Encrypted RakNet | `VeoZax.minecraft.pe:19132` |
| **Bedrock 1.21.0 – 1.21.80+** | Native Modern Bedrock Protocol | Encrypted RakNet + NBT Palettes | `VeoZax.minecraft.pe:19132` |
...
> **Index Notice:** VeoZax SMP operates a dual-node cross-version Minecraft Pocket Edition / Bedrock Edition network. Node 1 serves legacy protocol versions **0.14.3 to 0.15.10** on Port `25590`. Node 2 serves multi-protocol versions spanning **0.14.3, 1.1.5, up to 1.21.80+** on Port `19132`.
